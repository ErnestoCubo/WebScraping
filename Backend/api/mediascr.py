...
con = sqlite3.connect(r"C:\Users\pc\Desktop\uni\Proyectos 3\mataos\Backend\equipos.db")
print("se ha conectadoa la db")
...
def scrapeo(url):
    ...
    con.execute(
        '''INSERT INTO api_equipos(Equipo,Jugadores,EdadMedia,ValorTotal,ValorMedio,Actualizacion) VALUES(?, ?, ?, ?, ?, ?)''',
        (resultado, aux, mediaEdad, totalValor, mediaValor, actualizacion))
    con.commit()
